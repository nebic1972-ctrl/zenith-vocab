...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-white">Haftalık Aktivite</h2>
            <Link
              href="/statistics"
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-white">Son Kelimeler</h2>
            <Link
              href="/vocabulary"
              className="text-sm text-blue-400 hover:text-blue-300 font-semibold flex items-center gap-1"
            >
      ...
      {/* Başarımlar */}
      <div className="bg-gray-900 rounded-xl border border-gray-800 p-6 mb-8">
        <h2 className="text-xl font-bold text-white mb-6">🏆 Başarımlar</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
        <motion.button
          ...
          className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
        >
        ...
        <Link
          href="/vocabulary"
          className="bg-gradient-to-br from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 text-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all block"
        >
        ...
        <Link
          href="/collections"
          className="bg-gray-900 border border-gray-800 hover:border-purple-500/50 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all block group"
        >
          <div className="flex items-start justify-between mb-4">
            <div className="w-12 h-12 bg-purple-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
              <FolderOpen size={24} className="text-purple-400" />
            </div>
            <ArrowRight size={20} className="text-gray-500 group-hover:text-purple-400 transition-colors" />
          </div>
          <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-purple-400 transition-colors">
            Koleksiyonlar
          </h3>
          <p className="text-gray-400 text-sm">
            Kelimelerinizi gruplandırın
          </p>
        </Link>
        <Link
          href="/statistics"
          className="bg-gray-900 border border-gray-800 hover:border-blue-500/50 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all block group"
        >
          <div className="flex items-start justify-between mb-4">
